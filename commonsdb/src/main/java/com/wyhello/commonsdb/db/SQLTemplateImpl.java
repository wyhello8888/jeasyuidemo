...
public class SQLTemplateImpl implements SQLTemplate{
	 ...
	 *  查询
	 */
	public Collection<? extends Object> query(String sql,Object[]args,RsMappingObject mapper){
		PreparedStatement pstmt = null;
		ResultSet rs = null;
...
/*	public static void main(String[] args){
		new SQLTemplate().update("insert into emp values(?,?,?,?,?,?,?,?)"
			,new Object[]{new Integer(1111),"MARK","CLECK",new Integer(1188),new Date(System.currentTimeMillis())
					,new Integer(12341),new Integer(0),new Integer(20)});
